...
const renderStatsCard = (stats, options = {}) => {
    ...
    STATS.issues = {
        ...
        value: contributionsCollection.totalIssueContributions,
        id: "issues",
    };
  ...
  */
    ...
    const minCardWidth =
        (statItems.length ? RANK_CARD_MIN_WIDTH : RANK_ONLY_CARD_MIN_WIDTH) +
        iconWidth;
    ...
    const calculateRankXTranslation = () => {
        if (statItems.length) {
            ...
            if (width > RANK_CARD_DEFAULT_WIDTH) {
                const xMaxExpansion =
                    minXTranslation + (450 - minCardWidth) / 2;
    ...
    const rankCircle = `<g data-testid="rank-circle"
